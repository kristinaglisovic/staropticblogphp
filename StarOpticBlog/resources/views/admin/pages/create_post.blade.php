...
@section('title') Kreiranje postova @endsection
@section('content')
    <!-- Main content -->
    <div class="content">
        @if(session('msg'))
                ...
                <div class="form-group py-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control
                               ...
                               placeholder="Naslov" value="{{old('title')}}">
                        @error('title')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="main_text" name="main_text" class="w-100" rows="5" >{{old('main_text')}}</textarea>
                        @error('main_text')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{old('subtitle')}}" class="form-control  {{$errors->has('subtitle') ? 'novalid' :  session('sent')}}" id="subtitle" name="subtitle" placeholder="Podnaslov">
                        @error('subtitle')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="subtitle_text_1" class="w-100" rows="5" name="subtitle_text_1">{{old('subtitle_text_1')}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{old('quote')}}" class="form-control" id="quote" name="quote" placeholder="Citat">
                        @error('quote')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <textarea id="subtitle_text_2" class="w-100" rows="5" name="subtitle_text_2">{{old('subtitle_text_2')}}</textarea>
