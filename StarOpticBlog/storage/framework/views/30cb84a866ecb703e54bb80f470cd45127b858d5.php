...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="post-comments">
                        ...
                        <div class="comment">
                            <div class="comment-body">
                                ...
                                <p><?php echo e($comm->comment); ?></p>  <form action="<?php echo e(route('comment.destroy.front',$comm)); ?>" method="post"><?php echo csrf_field(); ?> <?php echo method_field('delete'); ?><input type="submit" class="btn mali text-info" name="obrisiKomentar" value="Obriši"/></form>
    ...
    <?php else: ?>
        <main class="post blog-post col-lg-8">
        <div class="alert alert-info text-dark text-center"><p>Post nije objavljen i ne možete ga videti.</p></div>
        </main>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.front.postslayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\StarOpticBlog - Copy - Copy - Copy (2) OVAJ\resources\views/front/pages/blog/single-blog-post.blade.php ENDPATH**/ ?>